...
class GraceAgent():
    ...
    def __init__(self):
        ...
        self.system_prompt = ("You are Grace's scheduling assistant.\n"
                    "Your only job is to use the 'get_availability' tool "
                    "to answer questions about Grace's schedule for playing badminton.\n\n"
...
#agent = GraceAgent()
#import asyncio
#response = asyncio.run(agent.get_response(query="Is Grace available on 8th Nov 2025? ", context_id=1234))
#print(response)