...
from agent_executor import LinusAgentExecutor
...
def main(host = "localhost", port = 10005):
    ...
    skill = AgentSkill(
        ...
        description="Helps with finding Linus's availability for Badminton",
    ...
    agent_card = AgentCard(
        ...
        version="1.0.0",
        defaultInputModes=LinusAgent.SUPPORTED_CONTENT_TYPES,
        defaultOutputModes=LinusAgent.SUPPORTED_CONTENT_TYPES,
    ...
    request_handler = DefaultRequestHandler(
        agent_executor=LinusAgentExecutor(),
